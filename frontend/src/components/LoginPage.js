...
import { STATUS_CODE_OK, STATUS_CODE_NOT_VALID, STATUS_CODE_DATABASE_FAILURE, STATUS_CODE_BAD_REQUEST } from "../constants";
...
function LoginPage() {
    ...
    const handleLogin = async () => {
        await axios.post(URL_LOGIN_SVC, { username, password }).then(response => {
